...
"submit");e.lastChild.setAttribute("data-name",c.name);e.lastChild.innerHTML="Going ";e.lastChild.appendChild(b("SPAN"));e.childNodes[2].lastChild.setAttribute("id",c.id);e.childNodes[2].lastChild.classList.add("badge");e.childNodes[2].lastChild.innerHTML=0;l.appendChild(t).setAttribute("class","avgScreen");t.setAttribute("title","Visit Website");t.appendChild(b("A")).setAttribute("href",c.url);t.firstChild.setAttribute("target","_blank");t.firstChild.setAttribute("rel","external");t.firstChild.innerHTML=
